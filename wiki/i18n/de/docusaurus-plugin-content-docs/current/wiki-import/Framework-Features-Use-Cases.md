...
Reference: [`FFI-Bridge-Reference`](/wiki/wiki-import/FFI-Bridge-Reference)
...
Reference: [`Web-UI-Bridge`](/wiki/wiki-import/Web-UI-Bridge)
...
- immediate persistence to JSON under `UserData/ModCfg`

Reference: [`Mod Config System`](/wiki/wiki-import/Mod-Config-System)
...
1. Prepare catalog file ([`docs/wiki/references/assembly-hooks.txt`](/wiki/references/) or exported dump).
