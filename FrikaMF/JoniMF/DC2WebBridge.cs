...
public static class DC2WebBridge
{
    ...
    public static void RegisterBundle(string screenKey, Dc2WebBundle bundle)
    {
        ...
        ProfilesByScreen[screenKey] = BuildProfile(bundle);
    }
    ...
    private static UnityUiStyleProfile BuildProfile(Dc2WebBundle bundle)
    {
        var profile = new UnityUiStyleProfile { ReplaceExistingUi = bundle.ReplaceExistingUi };
