...
internal static class Patch_HRSystem_OnEnable
{
    internal static void Postfix(HRSystem __instance)
    {
        try
        {
            ...
            bool handledByWeb = UiExtensionBridge.TryApplyOrReplace(__instance.gameObject, "HRSystem");
            if (!handledByWeb)
                UiExtensionBridge.TryModernize(__instance.gameObject, "HRSystem.OnEnable");
        }
        catch (Exception ex)
        {
...
internal static class Patch_MainMenu_Start
{
    internal static void Postfix(MainMenu __instance)
    {
        try
        {
            bool handledByWeb = UiExtensionBridge.TryApplyOrReplace(__instance.gameObject, "MainMenu");
            if (!handledByWeb)
                UiExtensionBridge.TryModernize(__instance.gameObject, "MainMenu.Start");
        }
        catch (Exception ex)
        {
...
internal static class Patch_MainMenu_Settings
{
    internal static void Postfix(MainMenu __instance)
    {
        try
        {
            UiExtensionBridge.OnSettingsOpened(__instance);
        }
        catch (Exception ex)
        {
...
internal static class Patch_ComputerShop_InteractOnClick
{
    internal static void Postfix(ComputerShop __instance)
    {
        try
        {
            bool handledByWeb = UiExtensionBridge.TryApplyOrReplace(__instance.gameObject, "ComputerShop");
            if (!handledByWeb)
                UiExtensionBridge.TryModernize(__instance.gameObject, "ComputerShop.InteractOnClick");
        }
        catch (Exception ex)
        {
